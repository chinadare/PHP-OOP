							...
							<table id="zctb" class="display table  table-bordered table-hover" cellspacing="0" width="100%">
								...
								<th>Page 2 </th>
									...
									$database = DB:: getinstance()->query('SELECT * FROM tbl_customer JOIN tbl_customer_purchase ON tbl_customer.c_id=tbl_customer_purchase.id');
										...
										foreach($database->results() as $database){
										echo "<form name='frmLogin' method='POST' action='app_soft_copy.php'>";
										...
										echo	'<td><input type="image" alt="Submit" src="'.$database->image2.'" width="50" height="50"> </td>';
										echo	'<td><input type="image" alt="Submit" src="'.$database->road_image.'" width="50" height="50"> </td>';	
