...
<body>
	...
	<div class="container-fluid">							
		...
		<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Administrator] : Edit Profile <a/> </p>	
				...
				<div class="panel panel-default">
					...
					<form class="form-horizontal" method="POST" action="#" enctype='multipart/form-data'>
						...
						<tr>
							<td> Full Name </td>
							<td> 
								<input class="form-control"  type="text" name="txtfname" value="<?php echo $database->Full_Emp_name; ?>" />
							</td>
						</tr>
						</div>
						...
						<tr>
							...
							<td> 
								<input class="form-control"  type="text" name="txtcon" value="<?php echo $database->Con_No; ?>" />
							</td>
						</tr>
						</div>
				...
				<div class="panel panel-default">
					...
					<form class="form-horizontal" method="POST" action="#" name="frmChnPw">
						<tr>
							...
							<td> 
								<input class="form-control"  type="password" name="txtcpass" />
							</td>
						</tr>
						</div>
