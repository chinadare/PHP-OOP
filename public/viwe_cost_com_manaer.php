	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class='open'><a href="viwe_cost_com_manaer.php"><i class="fa fa-dashboard"></i> View  project Cost Compare</a></li>
		 ...
		 <div class="content-wrapper"> 
			...
			<div class="container-fluid"> 
				<div class="container">
								<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Manager] : Actual Project Cost Compare Summery <a/> </p>
				<tr>
								<?php
								if(Input::exists()){
