...
<body>
	...
	<div class="ts-main-content">
		...
		<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Clerk] : Land Resell 6 Months<a/> </p>
				...
				?>
						<div class="panel-body">
							...
							<?php
							$database = DB:: getinstance()->query('SELECT tbl_six_month.id,tbl_six_month.project_id,tbl_six_month.due_date,tbl_six_month.Block,tbl_six_month.but_id,tbl_project.pj_name,tbl_customer.full_name FROM tbl_six_month,tbl_project,tbl_customer WHERE  tbl_six_month.project_id=tbl_project.id AND tbl_six_month.cus_id=tbl_customer.c_id AND tbl_six_month.Re_status=1');
