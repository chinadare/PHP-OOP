...
<body>
	...
	<div class="ts-main-content">
		...
		<div class="container">
			...
			<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Manager] : Actual Cost Summery <a/> </p>
					...
					<div class="col-md-4">
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Day </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->Cp_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_SC_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="col-md-4">
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_FE_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="col-md-4">
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Reno Of Existing Building </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_PH_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
								echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_WW_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';									
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_CL_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_RC_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_BAN_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="col-md-4">
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_DRA_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="container">
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date</td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_IT_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_IT_ROB_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';									
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date</td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_IT_FAL_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="container">
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date</td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_IT_TUR_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';									
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_WAS_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="col-md-4">
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td>  Date</td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_SE_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="container">	
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_FUEL_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_SaAD_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';									
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_AD_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
					...
					<div class="container">
						...
						<div class="panel panel-default">
							...
							if (Input::get('btnsessionW')){
									...
									echo '	<td> Date </td>';
									echo '	<td>'; 
									echo " <input class='form-control' type='text' name='txtCnic' value= '$database->D_LAE_date' disabled /> ";
									echo '	</td>';
									echo '</tr>';
									echo '</div>';
