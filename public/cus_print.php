...
<body>
	...
	<div class="ts-main-content">
		...
		<div id='printS' class="container">
			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">View Customers <button  class=" pull-right" onclick='printContent("printS")'><span class="glyphicon glyphicon-print"></span> Print </button> </div>
						<div class="panel-body">
							<table id="zctb" class="display table  table-bordered table-hover" cellspacing="0" width="100%">
								...
								<th>Customer Job </th>
									...
									<?php
									$database = DB:: getinstance()->query('SELECT tbl_customer.c_id,tbl_customer.full_name,tbl_customer.p_addr,tbl_customer.p_tele,tbl_customer_purchase.Block_No,tbl_customer.job,tbl_customer.nic,tbl_project.pj_name FROM tbl_customer,tbl_customer_purchase,tbl_project WHERE tbl_customer.c_id=tbl_customer_purchase.id AND tbl_customer_purchase.pr_name=tbl_project.id ');
		...
		<div  class="container">
			<div align="center"> <a type="button" class="btn btn-success" href="Exe_viwe_customer.php" data-target="Signin">GO back</a> </div>
		</div>	
