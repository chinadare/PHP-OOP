...
//}
								...
								/*	if(Input::exists()){
										...
										if (Input::get('btnAddBan4')){

											$_SESSION['4yearssine']	=	Input::get('txtId4yr');

											Redirect::to('4year_single.php');
	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class='open'><a href="report_4year.php"><i class="fa fa-dashboard"></i> 4 Year report</a></li>
		...
		<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Manager] : 4 Year  Summery <a/> </p>

			<div class="">
				<div class="panel panel-default">
					<div class="panel-heading">4 Year Report <button  class=" pull-right" onclick='printContent("printS")'><span class="glyphicon glyphicon-print"></span> Print </button> </div>
						<div class="panel-body">
							<table id="zctb" class="display table  table-bordered table-hover" cellspacing="0" width="100%">
								...
								<th>Action </th>
									...
									<?php
									$database = DB:: getinstance()->query('SELECT 4_years_plan.c_id,tbl_customer_purchase.c_name,tbl_project.pj_name,4_years_plan.Block,4_years_plan.sum_Amount,4_years_plan.discount,4_years_plan.due_date,4_years_plan.Deposite,4_years_plan.No_Installments,4_years_plan.Installments_free,4_years_plan.complete FROM tbl_customer_purchase,tbl_project,4_years_plan WHERE tbl_customer_purchase.pr_name=tbl_project.id  AND 4_years_plan.c_id=tbl_customer_purchase.id');

										if(!$database->count()){
											echo "No record";
										}
										foreach($database->results() as $database){
										echo "<form name='frmLogin' method='POST' action='4year_single.php'>";
										
										echo	"<tbody>";
										echo	"<tr>";
									//	$_SESSION['report4year'] = $database->c_id;
										...
										echo	" <td> $database->No_Installments </td> ";
										echo	" <td> $database->Installments_free </td> ";

										echo "<input type='hidden' name='txtId4yr' value=".$database->c_id." />";
										echo "<input type='hidden' name='txtId4name' value=".$database->c_name." />";
										...
										echo '<td> <input class="btn btn-info" type="submit" name="btnAddBan4" value="SELECT" /> </td>';
