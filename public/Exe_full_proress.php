...
if ($user->hasPermission('executive')) {
	...
	$customerId =  $_SESSION['progresscustomerFull'];
				...
				if($validation->passed()){
					...
					echo $new_checNo;
						...
						$id = $_SESSION['progressid'];
						    		...
						    		$user->update('full_cash_progress',array(
									"total_payment_re" => $new_sub,
									"total_payment_be_re" => $new_total1,
...
<div class="content-wrapper">
	...
	<div class="container">
			...
			<?php
									...
									$database = DB:: getinstance()->query("SELECT * FROM full_cash_progress WHERE c_id='$customerId'");
		...
		<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Clerk] : Customer Payment - Full Cash <a/> </p>
			<div class="col-md-9">
	 						...
	 						<table class="table table-bordered table-striped">
								...
								<form name="frmAddProp" method="POST" action="#">
									...
									<tr>
										...
										<td> 
											<input class="form-control" id='total2U' type="text" readonly name="txtPcost1t" placeholder='Rs : 0.00' value='<?php if(isset($min)){echo $min;} ?>'/>
									...
									<tr>
										...
										<td> 
											<input class="form-control" id='totalnew' type="text" readonly name="txtReco" placeholder='Rs : 0.00' value='<?php if(isset($new_amoun)){echo $new_amoun;} ?>'/>
									...
									<tr>
										<td> Amount </td>
										<td> 
											<input id='total2' class="form-control" step="any" placeholder='RS 0.00' type="number" name="txtReco1"  required />
									...
									<tr>
										<td> Total</td>
										<td> 
											<input id='totalFinal' class="form-control" readonly type="text" name="txtfinalA" value="0.00" />
