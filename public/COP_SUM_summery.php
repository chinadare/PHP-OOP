	...
	<div class="ts-main-content">
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				...
				<li class="open"><a href="COP_SUM_summery.php"><i class="fa fa-dashboard"></i> Project Cost Summery </a></li>
		 ...
		 <div class="content-wrapper"> 
			...
			<div class="container-fluid"> 
				<div class="container">
					<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Managering Director] : Viwe Project Difference  <a/> </p>
				<tr>
								<?php
								if(Input::exists()){
		...
		<div class="container"> <!-- 1st -->
			...
			<div class="col-md-12" id='printS2'>
				...
				<div class="panel panel-default">
					<div class="panel-heading">Current Projects <button  class=" pull-right" onclick='printContent("printS2")'><span class="glyphicon glyphicon-print"></span> Print </button> </div>
						<div class="panel-body">
							<table id="zctb" class="display table  table-bordered table-hover" cellspacing="0" width="100%">
								...
								<th class='text-primary'><p class="text-primary">Purchase Cost (Start)</p></th>
								<th class='text-primary'><p class="text-primary">Development Cost (Start)</p></th>
								<th class='success'><p class="text-primary">project Cost (Start)</p></th>
