...
<body>
	...
	<li class='open'><a href="Exe_viwe_fcash.php"><i class="fa fa-dashboard"></i> Full Cash Projects</a></li>
		...
		<p style="font-size:120%;">  Welcome <a href="#" ><?php echo escape($user->data()->Emp_name);  ?> [Manager] : Full Cash Summery <a/> </p>
						...
						<div class="panel-body">
							<table id="zctb" class="display table  table-bordered table-hover" cellspacing="0" width="100%">
								...
								<th>Status</th>
									...
									<?php
									$database = DB:: getinstance()->query('SELECT * FROM tbl_full_cash,tbl_customer_purchase,tbl_project,full_cash_progress WHERE tbl_full_cash.customer_id= tbl_customer_purchase.id AND tbl_full_cash.project_id=tbl_project.id AND tbl_full_cash.id=full_cash_progress.c_id');
										...
										echo	" <td> $database->deposit </td> ";
										echo	" <td> $database->Total_selling_price </td> ";
										echo	" <td> $database->start_time </td> ";
